...
const UpcomingMovie = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://api.themoviedb.org/3/movie/upcoming?api_key=138dec1a639c4b6770dce3064a9d52e3&append_to_response=videos"
      )
      .then((response) => {
  ...
  return (
    <div className="w-full flex flex-col justify-center py-10 px-10 pb-5">
      <h1 className="font-Poppins text-4xl mb-8 pl-7">Upcoming</h1>
